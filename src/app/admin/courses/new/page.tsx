...
function NewCourseContent() {
  ...
  return (
    <main className="mx-auto flex w-full max-w-lg flex-1 flex-col px-6 py-16">
      <Link href="/admin/courses" className="mb-6 text-xs text-foreground/50 hover:text-foreground">
        &larr; Course builder
      </Link>
      <h1 className="font-display text-2xl text-foreground">New course</h1>
